...
import './formation-google-for-business.css';
...
const PresentationPage = () => {
    return (
        <>
            <Helmet>
                <title>Formation Google for Business - Emarketing Tunisie - IMSC</title>
                <meta name="description" content="Avec la Formation Google for Business Profiter de l’approche SEO et exploiter les possibilités de Google Suite sans être perdu dans ses fonctionnalités"></meta>
            </Helmet>

            <Layout>
                <div className="container-fluid google-business-container-style mt-5">
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-sm-12">
                            ...
                            <p className="p-style-form">
                                La formation <a className="text-decoration-none" href="../../service-seo-et-digital-marketing/index.html">Google for Business</a> s’adresse aux personnes qui disposent d’un background commercial, marketing, communication ou informatique et qui, en plus de leurs compétences professionnelles, souhaitent&nbsp;:
                            </p>

                            <ul>
                                <li className="p-style-form">
                                    Profiter de l’approche métier de spécialistes SEO pour exploiter les possibilités de Google Analytics sans être perdu dans les innombrables fonctionnalités de cet outil
                                </li>
                                <li className="p-style-form">
                                    Savoir quels profils, filtres, segments avancés et alertes configurer spécialement pour l’analyse du référencement naturel.
                                </li>
                                <li className="p-style-form">
                                    Apprendre à interpréter tous les rapports <a className="text-decoration-none" href="../../service-seo-et-digital-marketing/index.html">Google Analytics</a>   permettant l’optimisation du SEO.
                                </li>
                                <li className="p-style-form">
                                    Utiliser Google Analytics pour analyser toute les caractéristiques d’une baisse de trafic SEO, afin de prendre les mesures correctives nécessaires ( Google My Business , Google  Analytics, Google Search Console, Google Panda, MayDay, etc).
                                </li>
                            </ul>
                        </div>
                ...
                <div className="container mt-5">
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-sm-12">
                            ...
                            <h6 className="mt-lg-3">
                                M 1 : Présentation générale de Google Suite
                            </h6>

                            <ul>
                                <li className="p-style-form">
                                    Du compte Google au compte Google Suite
                                </li>
                                <li className="p-style-form">
                                    Comment Google Analytics enregistre ses données et où il les stocke
                                </li>
                                <li className="p-style-form">
                                    Notion de code de suivi
                                </li>
                                <li className="p-style-form">
                                    Approche simplifiée des profils Google Analytics (« principaux » et « secondaires »)
                                </li>
                                <li className="p-style-form">
                                    Gestion des utilisateurs : accès aux comptes et profils
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="col-lg-6 col-sm-12">
                            <h6 className="mt-lg-5">
                                M 2 : Suivi du référencement avec Google Suite :
                            </h6>

                            <ul>
                                <li className="p-style-form">
                                    Mesurer le trafic total et la part du SEO
                                </li>
                                <li className="p-style-form">
                                    Comment isoler le trafic de notoriété (marque) du reste
                                </li>
                                <li className="p-style-form">
                                    Comment faire du tracking : exemple de Twitter
                                </li>
                                <li className="p-style-form">
                                    Comment utiliser Google Analytics pour analyser les mots-clés générateurs de trafic (requêtes) ; astuces pour exporter les données
                                </li>
                                <li className="p-style-form">
                                    les principales expressions régulières à connaître pour l’analyse du référencement
                                </li>
                                <li className="p-style-form">
                                    Comment analyser les pages les plus performantes en référencement naturel, et celles qui doivent être optimisées en priorité
                                </li>
                                <li className="p-style-form">
                                    exploitation des rapports sur la recherche interne
                                </li>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-sm-12">
                            ...
                            <h6 className="mt-lg-5">
                                M 3: Utilisation avancée de Google Suite
                            </h6>

                            <ul>
                                <li className="p-style-form">
                                    Comment identifier le trafic généré par certains types de pages, pour aider au travail d’optimisation du réf. nat.
                                </li>
                                <li className="p-style-form">
                                    Comment détecter si son site a une pénalité Google : quelles parties du site ? avec quelle source de trafic, quels genres de mots-clés, etc. Très utile pour l’analyse de Panda, des filtres du Duplicate Content, etc.
                                </li>
                                <li className="p-style-form">
                                    Comment mettre en place des alertes de surveillance du référencement
                                </li>
                                <li className="p-style-form">
                                    comment utiliser les objectifs et les rapports personnalisés pour mesurer l’efficacité du référencement naturel (comment mesurer combien le SEO contribue au chiffre d’affaires ou succès du site)
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="col-lg-6 col-sm-12">
                            <h6 className="mt-lg-5">
                                M 4 : TP Google Business Suite
                            </h6>

                            <ul>
                                <li className="p-style-form">
                                    Nos conseils sur la liste des profils à créer systématiquement dans vos comptes Google Analytics ou ceux de vos clients
                                </li>
                                <li className="p-style-form">
                                    20 exemples concrets (filtres, segments avancés et autres astuces) qui vous serviront au quotidien pour analyser et optimiser votre référencement
                                </li>
                                <li className="p-style-form">
                                    <strong>
                                        Test d’évaluation
                ...
                <ButtonComponent type="Formation Google for Business" />
