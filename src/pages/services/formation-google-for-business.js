                    ...
                    <div className="row">
                        <div className="col-lg-8 col-sm-12">
                            ...
                            <p className="p-style-form">
                                La formation <a class="text-decoration-none" href="../../service-seo-et-digital-marketing/index.html">Google for Business</a> s’adresse aux personnes qui disposent d’un background commercial, marketing, communication ou informatique et qui, en plus de leurs compétences professionnelles, souhaitent&nbsp;:
                            </p>
                            ...
                            <ul>
                                ...
                                <li className="p-style-form">
                                    Apprendre à interpréter tous les rapports <a class="text-decoration-none" href="../../service-seo-et-digital-marketing/index.html">Google Analytics</a>   permettant l’optimisation du SEO.
                                </li>
                                <li className="p-style-form">
