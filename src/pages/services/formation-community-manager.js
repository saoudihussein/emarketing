...
import './formation-community-manager.css';
...
const PresentationPage = () => {
    return (
        <>
            <Helmet>
                <title>Formation Community Manager - Emarketing Tunisie - IMSC</title>
                <meta name="description" content="Avec la formation Community Manager vous allez découvrir le métier , ou comment gérer une présence et une e-réputation sur les réseaux sociaux"></meta>
            </Helmet>

            <Layout>
                <div className="container-fluid community-manager-container-style mt-5">
                        ...
                        <div className="row mt-5 mb-5 pb-5 pt-5">
                            ...
                            <div className="text-center">
                                ...
                                <span className="text-prese-style" aria-current="page" to="#">
                                    {">>"}
                                    <span className="name-prese-style" aria-current="page" to="#">
                                        Formation Community Manager                                    </span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-sm-12">
                            ...
                            <p className="p-style-form">
                                Avec cette formation vous allez découvrir le métier de <a className="text-decoration-none" href="index.html">Community Manager</a>, ou comment gérer une présence et une e-réputation sur les réseaux sociaux à l’aide de méthodes concrètes et efficaces. Vous allez explorer des outils pour être à l’écoute sur les réseaux sociaux, et vous verrez comment créer et animer une communauté digitale :
                            </p>
                            ...
                            <ul>
                                ...
                                <li className="p-style-form">
                                    Utiliser les réseaux sociaux comme levier économique pour l’<a className="text-decoration-none" href="../../solutions-entreprise/index.html">entreprise</a>
                                </li>
                                <li className="p-style-form">
                ...
                <div className="container mt-5">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-sm-12">
                            <h6 className="mt-lg-5">
                                M 2 : Être à l'écoute sur les réseaux
                            </h6>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-sm-12">
                            ...
                            <h6 className="mt-lg-5">
                                M 3: Comment s'exprimer sur les social medias
                            </h6>

                            <ul>
                                <li className="p-style-form">
                                    La community de partage
                                </li>
                                <li className="p-style-form">
                                    La communauté d’influence
                                </li>
                                <li className="p-style-form">
                                    La community de collaboration
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="col-lg-6 col-sm-12">
                            <h6 className="mt-lg-5">
                                M 4 : Gérer une Digital Community
                            </h6>

                            <ul>
                                <li className="p-style-form">
                                    Comment animer une community ?
                                </li>
                                <li className="p-style-form">
                                ...
                                <li className="p-style-form">
                                    Comment utiliser LES KPI sur les réseaux sociaux ?
                                </li>
                                <li className="p-style-form">
                ...
                <ButtonComponent type="Formation Community Manager"/>
