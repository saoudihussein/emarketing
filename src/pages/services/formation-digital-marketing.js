...
import './formation-digital-marketing.css';
...
const PresentationPage = () => {
    return (
        <>
            <Helmet>
                <title>Formation Digital Marketing - Emarketing Tunisie - IMSC</title>
                <meta name="description" content="Acquérir une vision synthétique de l’évolution du marketing digital et Gagner en responsabilité dans le domaine de la stratégie numérique."></meta>
            </Helmet>

            <Layout>
                <div className="container-fluid digital-marketing-container-style mt-5">
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-sm-12">
                            ...
                            <p className="p-style-form">
                                La formation DIGITAL MARKETING s’adresse aux personnes qui disposent d’un background commercial, marketing, communication ou informatique et qui, en plus de leurs compétences professionnelles, souhaitent :
                            </p>

                            <ul>
                                <li className="p-style-form">
                                    Acquérir une vision synthétique de l’évolution du <a href="../../service-seo-et-digital-marketing/index.html">marketing digital</a>
                                </li>
                                <li className="p-style-form">Gagner en responsabilité dans le domaine de la stratégie numérique</li>
                                <li className="p-style-form">Accéder aux postes les plus recherchés du marché professionnel</li>
                                <li className="p-style-form">Comprendre comment et pourquoi le marketing évolue à l’ère du digital</li>
                                <li className="p-style-form">Faire le point sur l’évolution des grandes étapes du marketing digital : attirer, retenir, convertir</li>
                                <li className="p-style-form">Comprendre comment le Big data sert la personnalisation en marketing digital</li>
                                <li className="p-style-form">Expérimenter le marketing digital et se nourrir d’exemples très concrets</li>
                                <li className="p-style-form">Participer à une merveilleuse aventure digitale avec des milliers de participants, des experts, des <a href="../formation-media-buying/index.html">startups </a>et des témoignages d’entreprises</li>
                            </ul>
                        </div>
                ...
                <div className="container mt-5">
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-sm-12">
                            ...
                            <h6 className="mt-lg-3">
                                M 1 : La transformation digitale du marketing
                            </h6>

                            <ul>
                                <li className="p-style-form">
                                    La transformation digitale des entreprises… et du marketing !
                                </li>
                                <li className="p-style-form">
                                    Du marketing au digital marketing
                                </li>
                                <li className="p-style-form">
                                    Comment articuler entre l’online et offline marketing ?
                                </li>
                                <li className="p-style-form">
                                    Nouvelles technologies et nouvelles tendances du marketing
                                </li>
                                <li className="p-style-form">
                                    L’interruption marketing et permission marketing.
                                </li>
                                <li className="p-style-form">
                        ...
                        <div className="col-lg-6 col-sm-12">
                            <h6 className="mt-lg-5">
                                M 2 : Le marketing digital pour attirer et Fidéliser
                            </h6>
                            ...
                            <ul>
                                ...
                                <li className="p-style-form">
                                    Les apports de l’Inbound marketing et les stratégies de content market.
                                </li>
                                <li className="p-style-form">
                                    Référencement naturel et sponsorisé
                                </li>
                                <li className="p-style-form">
                                    Réseaux sociaux et community management
                                </li>
                                <li className="p-style-form">
                                    Repensez le marketing vs le Growth Hacking
                                </li>
                                <li className="p-style-form">
                                    L’e-réputation
                                </li>
                                <li className="p-style-form">
                                    “expérience utilisateur” (UX) et la notion d’UI
                                </li>
                                <li className="p-style-form">
                                    Comment retenir ses prospects et clients avec l’email
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-sm-12">
                            ...
                            <h6 className="mt-lg-5">
                                M 3: Le marketing digital pour convertir le prospect en client
                            </h6>
                            ...
                            <ul>
                                ...
                                <li className="p-style-form">
                                    La dominance des marketplaces
                                </li>
                                <li className="p-style-form">
                                    Avis utilisateurs
                                </li>
                                <li className="p-style-form">
                                    L’emailing, le meilleur ROI pour les canaux digitaux.
                                </li>
                                <li className="p-style-form">
                                    La notoriété de l’entreprise dans une stratégie digitale
                                </li>
                                <li className="p-style-form">
                                    eCRM: les bases marketing
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="col-lg-6 col-sm-12">
                            <h6 className="mt-lg-5">
                                M 4 : Le big data et la Plateforme emailing
                            </h6>
                            ...
                            <ul>
                                ...
                                <li className="p-style-form">
                                    Analytics et “data driven”
                                </li>
                                <li className="p-style-form">
                                    La Data Management Platforms
                                </li>
                                <li className="p-style-form">
                                    Les KPI pour piloter le marketing
                                </li>
                                <li className="p-style-form">
                                    <strong>
                                        Test d’évaluation
